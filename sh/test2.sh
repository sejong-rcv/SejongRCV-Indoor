OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES=7 python sh/baseline.py \
    --sf test_1f_ens-6_notrain_trainall_lmr10-09_undist_cov1_noniter --port 8823 \
    ...
    --pose_covisibility 1 --pose_noniter --lmr_score 0.9\
    --topk_save top10_ens-6_lmr10-05_1f_all.npy
